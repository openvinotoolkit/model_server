...
```
Read more about [Get Model Status API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2024/4/client/python/tensorflow-serving-api/samples/README.md#model-status-api-1)
...
Read more about [Get Model Metadata API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2024/4/client/python/tensorflow-serving-api/samples/README.md#model-metadata-api-1)
...
Read more about [Predict API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2024/4/client/python/tensorflow-serving-api/samples/README.md#predict-api-1)
