...
Read more about [Predict API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2023/1/client/python/tensorflow-serving-api/samples/README.md#predict-api-1)
