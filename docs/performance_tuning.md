...
Note that currently the `PERFORMANCE_HINT` property is supported by CPU and GPU devices only. [More information](https://docs.openvino.ai/2023.2/openvino_docs_OV_UG_Performance_Hints.html#performance-hints-how-it-works).
...
> **NOTE**: For additional information, read [supported configuration parameters for all plugins](https://docs.openvino.ai/2023.2/groupov_runtime_cpp_prop_api.html?#detailed-documentation).
...
1. [Launch OV benchmark app](https://docs.openvino.ai/2023.2/openvino_inference_engine_tools_benchmark_tool_README.html?highlight=benchmark)
...
2. [Launch OVMS benchmark client](https://docs.openvino.ai/2023.2/ovms_demo_benchmark_client.html) on the same machine as OVMS
3. [Launch OVMS benchmark client](https://docs.openvino.ai/2023.2/ovms_demo_benchmark_client.html) from remote machine
