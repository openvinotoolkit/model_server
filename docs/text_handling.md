...
There is a built-in [Tokenizer](https://github.com/openvinotoolkit/model_server/tree/releases/2024/0/src/custom_nodes/tokenizer) custom node for that use case based on Blingfire library.
