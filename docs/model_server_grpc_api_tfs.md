...
Gets information about the status of served models including Model Version
 ...
 Read more about [Get Model Status API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2025/4/client/python/tensorflow-serving-api/samples/README.md#model-status-api).
...
Read more about [Get Model Metadata API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2025/4/client/python/tensorflow-serving-api/samples/README.md#model-metadata-api).
...
Read more about [Predict API usage](https://github.com/openvinotoolkit/model_server/blob/releases/2025/4/client/python/tensorflow-serving-api/samples/README.md#predict-api)
...
- [Example client code](https://github.com/openvinotoolkit/model_server/blob/releases/2025/4/client/python/tensorflow-serving-api/samples/README.md) shows how to use GRPC API and REST API.
