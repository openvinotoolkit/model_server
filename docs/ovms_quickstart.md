...
OpenVINO Model Server can perform inference using pre-trained models in either [OpenVINO IR](https://docs.openvino.ai/2024/openvino_docs_MO_DG_IR_and_opsets.html#doxid-openvino-docs-m-o-d-g-i-r-and-opsets) 
...
- converting models from any formats using [Model Optimizer](https://docs.openvino.ai/2024/openvino_docs_MO_DG_Deep_Learning_Model_Optimizer_DevGuide.html)
