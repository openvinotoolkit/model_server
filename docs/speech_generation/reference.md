...
-    `optional string target_device` - device to load models to. Supported values: "CPU", "GPU", "NPU". Default value is set to GPU if available on the platform, CPU otherwise.
