...
- [OpenVINO IR](https://docs.openvino.ai/2024/openvino_docs_MO_DG_IR_and_opsets.html#doxid-openvino-docs-m-o-d-g-i-r-and-opsets), where the graph is represented in .bin and .xml files 
...
OpenVINO’s [Model Optimizer](https://docs.openvino.ai/2024/openvino_docs_MO_DG_Deep_Learning_Model_Optimizer_DevGuide.html) for IR, or different
