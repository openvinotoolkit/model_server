...
a [documented method](https://github.com/openvinotoolkit/model_server/tree/v2021.4.2/extras/nginx-mtls-auth) for including NGINX reverse proxy with mTLS traffic termination.
