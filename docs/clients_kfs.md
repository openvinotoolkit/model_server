...
For complete usage examples see [Kserve samples](https://github.com/openvinotoolkit/model_server/tree/releases/2022/3/client/python/kserve-api/samples).
...
See our [C++ samples](https://github.com/openvinotoolkit/model_server/tree/releases/2022/3/client/cpp/kserve-api/README.md) to learn how to build a sample C++ client application. 
