...
> **NOTE**: Examples of using each of above endpoints can be found in [KServe samples](https://github.com/openvinotoolkit/model_server/tree/releases/2024/0/client/python/kserve-api/samples/README.md).
...
- [Example client code](https://github.com/openvinotoolkit/model_server/tree/releases/2024/0/client/python/kserve-api/samples/README.md) shows how to use GRPC API and REST API.
