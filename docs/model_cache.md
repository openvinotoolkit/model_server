...
In case there are valid reasons to enable the model cache also in those two conditions, it is possible to force enablement with `"disable_caching": false` parameter:
```
{
    "model_config_list": [
        {"config": {
