...
For models outside of OpenVINO organization follow the additional prerequisites described here: [Ovms pull mode](https://github.com/openvinotoolkit/model_server/blob/releases/2025/4/docs/pull_optimum_cli.md)
