...
```
[Example metrics output](https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2024/2/docs/metrics_output.out)
...
In OpenVINO Model Server repository you can find [grafana_dashboard.json](https://github.com/openvinotoolkit/model_server/blob/releases/2024/2/extras/grafana_dashboard.json) file that can be used to visualize per model metrics like:
