...
In OpenVINO Model Server repository you can find [grafana_dashboard.json](https://github.com/openvinotoolkit/model_server/tree/releases/2026/3/extras/grafana_dashboard.json) file that can be used to visualize per model metrics like:
