...
on [Shape Inference Document](https://docs.openvino.ai/2023.1/openvino_docs_OV_UG_ShapeInference.html).
...
- Example client in Python [face_detection.py](https://github.com/openvinotoolkit/model_server/blob/releases/2023/2/demos/face_detection/python/face_detection.py) that can be used to request inference with the desired input shape.
