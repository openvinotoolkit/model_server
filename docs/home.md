...
- works with [Bare Metal Hosts](build_from_source.md) as well as [Docker containers](docker_container.md) 
...
* [Landing on bare metal or virtual machine](build_from_source.md)
