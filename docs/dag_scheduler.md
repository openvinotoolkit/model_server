...
a C++ dynamic library implementing OVMS API defined in [custom_node_interface.h](https://github.com/openvinotoolkit/model_server/blob/releases/2024/4/src/custom_node_interface.h). Custom nodes can run the data
