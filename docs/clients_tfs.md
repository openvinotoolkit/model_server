...
Examples <https://github.com/openvinotoolkit/model_server/blob/releases/2024/3/client/python/tensorflow-serving-api/samples/README.md>
```
...
For complete usage examples see [ovmsclient samples](https://github.com/openvinotoolkit/model_server/tree/releases/2024/3/client/python/ovmsclient/samples).
