...
- install the required drivers - refer to [OpenVINO GPU configuration guide](https://docs.openvino.ai/2023.2/openvino_docs_install_guides_configurations_for_intel_gpu.html)
