...
In that cases you may need to add converter calculators as it was done [here](https://github.com/openvinotoolkit/model_server/blob/releases/2024/2/demos/mediapipe/object_detection/graph.pbtxt#L31).
