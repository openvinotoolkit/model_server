...
OV_SOURCE_BRANCH ?= 79a2fc1c4fa47921f681fdc2d6c388e184659aa9 # releases/2026/0 branch
OV_TOKENIZERS_BRANCH ?= master # releases/2026/0 branch
OV_GENAI_BRANCH ?= master # releases/2026/0 branch

OV_SOURCE_ORG ?= v-Golubev
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.1.0.0.dev20260221/openvino_genai_ubuntu24_2026.1.0.0.dev20260221_x86_64.tar.gz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.1.0.0.dev20260221/openvino_genai_ubuntu22_2026.1.0.0.dev20260221_x86_64.tar.gz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.1.0.0.dev20260221/openvino_genai_rhel8_2026.1.0.0.dev20260221_x86_64.tar.gz # not used
