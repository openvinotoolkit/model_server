...
OV_SOURCE_BRANCH ?= 9f43e0c9a5dab9b014a01259558aa8ddaa23d46c # 09.12.2025 master branch
OV_TOKENIZERS_BRANCH ?= a4d8fdf083e76147a5e8638a788e96f855084176 # 09.12.2025 master branch
OV_GENAI_BRANCH ?= b1d835c85c68ad2e3b57ea91423bf64b74581f82 # 09.12.2025 master branch
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251209/openvino_genai_ubuntu24_2026.0.0.0.dev20251209_x86_64.tar.gz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251209/openvino_genai_ubuntu22_2026.0.0.0.dev20251209_x86_64.tar.gz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251209/openvino_genai_rhel8_2026.0.0.0.dev20251209_x86_64.tar.gz # not used
