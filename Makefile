...
OV_SOURCE_BRANCH ?= 1bc6fa5b1654fcb644fe1f196e1d616e1f852ca7 # releases/2025/1 2025-03-13
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/pre-release/2025.1.0rc1/openvino_toolkit_ubuntu24_2025.1.0.dev20250313_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/pre-release/2025.1.0rc1/openvino_toolkit_ubuntu22_2025.1.0.dev20250313_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/pre-release/2025.1.0rc1/openvino_toolkit_rhel8_2025.1.0.dev20250313_x86_64.tgz
endif
