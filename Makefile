...
OV_SOURCE_BRANCH ?= 9bf706c887e542cdbb69fe6c233eb5d48b89706e # master 2025-07-28
OV_CONTRIB_BRANCH ?= c39462ca8d7c550266dc70cdbfbe4fc8c5be0677  # master / 2024-10-31
OV_TOKENIZERS_BRANCH ?= d9a2bb05e750f1c628ada5ed81457f880719fd73 # master 2025-05-26
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19607-9bf706c887e/openvino_toolkit_ubuntu24_2025.3.0.dev20250728_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19607-9bf706c887e/openvino_toolkit_ubuntu22_2025.3.0.dev20250728_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19607-9bf706c887e/openvino_toolkit_rhel8_2025.3.0.dev20250728_x86_64.tgz
  INSTALL_DRIVER_VERSION ?= "24.52.32224"
endif
