...
OV_SOURCE_BRANCH ?= 3ee669d7d10ce3cd5de075efe91978dacb633c21 # master 2025-07-15
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19500-3ee669d7d10/openvino_toolkit_ubuntu24_2025.3.0.dev20250715_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19500-3ee669d7d10/openvino_toolkit_ubuntu22_2025.3.0.dev20250715_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.3.0-19500-3ee669d7d10/openvino_toolkit_rhel8_2025.3.0.dev20250715_x86_64.tgz
  INSTALL_DRIVER_VERSION ?= "24.52.32224"
endif
