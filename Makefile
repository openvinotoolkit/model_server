...
OV_SOURCE_BRANCH ?= df6161d052577625d8812837f1b13010fd76c5af # master / 2025-03-03
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18325-df6161d0525/openvino_toolkit_ubuntu24_2025.1.0.dev20250303_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18325-df6161d0525/openvino_toolkit_ubuntu22_2025.1.0.dev20250303_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18325-df6161d0525/openvino_toolkit_rhel8_2025.1.0.dev20250303_x86_64.tgz
endif
