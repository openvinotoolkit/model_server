...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251209/openvino_genai_ubuntu22_2026.0.0.0.dev20251209_arm64.tar.gz
  endif
endif
ifeq ($(BASE_OS),redhat)
