...
ifeq ($(BASE_OS),ubuntu)
  ...
  DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_p_2022.1.0.618_offline.sh
endif
ifeq ($(BASE_OS),redhat)
  ...
  DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_runtime_rhel8_p_2022.1.0.618.tgz
endif
