...
OV_SOURCE_BRANCH ?= 4ebe493140b90cbaaa68e2c71fe8e1dbd7461822 # master 2025-04-21
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.2.0-18823-4ebe493140b/openvino_toolkit_ubuntu24_2025.2.0.dev20250421_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.2.0-18823-4ebe493140b/openvino_toolkit_ubuntu22_2025.2.0.dev20250421_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.2.0-18823-4ebe493140b/openvino_toolkit_rhel8_2025.2.0.dev20250421_x86_64.tgz
  INSTALL_DRIVER_VERSION ?= "24.52.32224"
endif
