...
OV_SOURCE_BRANCH ?= b982e19525eeecb0cf385591bd1ec182a781cb05  # master / 2024-12-19
OV_CONTRIB_BRANCH ?= c39462ca8d7c550266dc70cdbfbe4fc8c5be0677  # master / 2024-10-31
OV_TOKENIZERS_BRANCH ?= df5420cb2321c03875195a656a13319fe89c7a06 # master / 2024-12-19
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),20.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.0.0-17667-b982e19525e/l_openvino_toolkit_ubuntu22_2025.0.0.dev20241219_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.0.0-17667-b982e19525e/l_openvino_toolkit_rhel8_2025.0.0.dev20241219_x86_64.tgz
endif
