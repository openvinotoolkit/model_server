...
OV_SOURCE_BRANCH ?= e5c966fe779a2f9df233b189b455b2c6e5728efb # master 2025-03-12
OV_CONTRIB_BRANCH ?= c39462ca8d7c550266dc70cdbfbe4fc8c5be0677  # master / 2024-10-31
OV_TOKENIZERS_BRANCH ?= f1f171c6fb5583b260be0098c1103dcc5e80af8a # master 2025-03-10
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18450-e5c966fe779/openvino_toolkit_ubuntu24_2025.1.0.dev20250312_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18450-e5c966fe779/openvino_toolkit_ubuntu22_2025.1.0.dev20250312_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2025.1.0-18450-e5c966fe779/openvino_toolkit_rhel8_2025.1.0.dev20250312_x86_64.tgz
endif
