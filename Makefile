...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),20.04)
	...
	DLDT_PACKAGE_URL ?= http://ov-share-03.iotg.sclab.intel.com/volatile/openvino_ci/private_builds/dldt/releases/2024/3/commit/1e3b88e4e3f89774923e04e845428579f8ffa0fe/swf_drop/packages/releases/l_openvino_toolkit_ubuntu20_2024.3.0.16041.1e3b88e4e3f_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "23.22.26516"
	DLDT_PACKAGE_URL ?= http://ov-share-03.iotg.sclab.intel.com/volatile/openvino_ci/private_builds/dldt/releases/2024/3/commit/1e3b88e4e3f89774923e04e845428579f8ffa0fe/swf_drop/packages/releases/l_openvino_toolkit_ubuntu24_2024.3.0.16041.1e3b88e4e3f_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  INSTALL_DRIVER_VERSION ?= "23.22.26516"
  DLDT_PACKAGE_URL ?= http://ov-share-03.iotg.sclab.intel.com/volatile/openvino_ci/private_builds/dldt/releases/2024/3/commit/1e3b88e4e3f89774923e04e845428579f8ffa0fe/swf_drop/packages/releases/l_openvino_toolkit_rhel8_2024.3.0.16041.1e3b88e4e3f_x86_64.tgz
endif
