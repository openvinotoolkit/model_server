...
OV_SOURCE_BRANCH ?= 3bb08f7a3ba1988a37c06e544dd24e0c2b421784 # 19.12.2025 master branch
OV_TOKENIZERS_BRANCH ?= 60a9e5067e434b8721719479f2e1eb750ae7bd81 # 19.12.2025 master branch
OV_GENAI_BRANCH ?= 67f9b81244a0b952beb4726b14d3b4f4e3d3559b # 19.12.2025 master branch
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),24.04)
	...
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251219/openvino_genai_ubuntu24_2026.0.0.0.dev20251219_x86_64.tar.gz
  else ifeq  ($(BASE_OS_TAG),22.04)
        OS=ubuntu22
	INSTALL_DRIVER_VERSION ?= "24.39.31294"
	DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251219/openvino_genai_ubuntu22_2026.0.0.0.dev20251219_x86_64.tar.gz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  DLDT_PACKAGE_URL ?= https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251219/openvino_genai_rhel8_2026.0.0.0.dev20251219_x86_64.tar.gz # not used
