...
OV_SOURCE_BRANCH ?= ee2962a50ce8ac0583b5b0d40dd46ff04428c8aa  # 2024.1
OV_CONTRIB_BRANCH ?= 8a7bf32f2e3e418ebb0b2aed31651342b7d135a0  # 2024.1
OV_TOKENIZERS_BRANCH ?= 50535e4e79db455913cd8443fd6ddd743fe1814c  # 02.04.2024 master
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),20.04)
	...
	DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_ubuntu20_2024.1.0.14951.ee2962a50ce_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
	INSTALL_DRIVER_VERSION ?= "23.22.26516"
	DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_ubuntu22_2024.1.0.14951.ee2962a50ce_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  INSTALL_DRIVER_VERSION ?= "23.22.26516"
  DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_rhel8_2024.1.0.14951.ee2962a50ce_x86_64.tgz
endif
