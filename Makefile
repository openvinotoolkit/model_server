...
OV_SOURCE_BRANCH ?= 03d54a579eaa7d6b100430413bbcdcd8a682b7cf  # 11.23.2023
OV_CONTRIB_BRANCH ?= ebc2ea20dd87e9f59e154fe5cc1e5b711a65b9e6  # 11.23.2023
...
ifeq ($(findstring ubuntu,$(BASE_OS)),ubuntu)
  ...
  ifeq ($(BASE_OS_TAG),20.04)
	...
	DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_ubuntu20_2023.3.0.13345.03d54a579ea_x86_64.tgz
  else ifeq  ($(BASE_OS_TAG),22.04)
	INSTALL_DRIVER_VERSION ?= "23.22.26516"
	DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_ubuntu22_2023.3.0.13345.03d54a579ea_x86_64.tgz
  endif
endif
ifeq ($(BASE_OS),redhat)
  ...
  DIST_OS=redhat
  INSTALL_DRIVER_VERSION ?= "23.22.26516"
  DLDT_PACKAGE_URL ?= http://s3.toolbox.iotg.sclab.intel.com/ov-packages/l_openvino_toolkit_rhel8_2023.3.0.13345.03d54a579ea_x86_64.tgz
endif
