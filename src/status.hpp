...
enum class StatusCode {
    ...
    OK_RELOAD_NEEDED,     /*!< Operation succeeded but no config reload was needed */
...
public:
    ...
    bool ok() const {
        return (code == StatusCode::OK || code == StatusCode::OK_RELOAD_NEEDED || code == StatusCode::OK_RELOAD_NOT_NEEDED);
    }
