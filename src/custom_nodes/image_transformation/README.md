...
**NOTE** Exemplary configuration files are available in [onnx model with server preprocessing demo](https://github.com/openvinotoolkit/model_server/tree/releases/2026/3/demos/using_onnx_model/python) and [config with single node](example_config.json).
