...
int initialize(void** customNodeLibraryInternalManager, const struct CustomNodeParam* params, int paramsCount) {
    ...
    const int queueSize = get_int_parameter("buffer_queue_size", params, paramsCount, 4);
    ...
    NODE_ASSERT(internalManager->createBuffersQueue(INPUT_GEOMETRY_INFO_DIMS_NAME, 2 * sizeof(uint64_t), queueSize), "buffer creation failed");
