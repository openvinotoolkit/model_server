    ...
    try {
        ...
        options->add_options()
            ...
            ("sequence_cleaner_poll_wait_minutes",
                "Time interval between two consecutive sequence cleanup scans. Default is 5. Zero value disables sequence cleaner. Note that it also calls malloc_trim() which attempts to release free memory from the heap.",
