...
const std::unordered_map<const StatusCode, const std::string> Status::statusMessageMap = {
    ...
    {StatusCode::FORBIDDEN_MODEL_GPU_IN_DAG, "Cannot use model on GPU in DAG"},
    ...
    {StatusCode::REQUESTED_GPU_ON_SUBSCRIBED_MODEL, "Requested target device GPU but model is used in pipeline"},
