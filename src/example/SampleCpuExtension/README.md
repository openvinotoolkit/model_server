...
Compile the library by running `make cpu_extension BASE_OS=ubuntu` in root directory of [Model Server repository](https://github.com/openvinotoolkit/model_server/tree/releases/2022/3). The implementation of this library slightly differs from the template in OpenVINO™ repository and can be found in [SampleCpuExtension directory](https://github.com/openvinotoolkit/model_server/tree/releases/2022/3/src/example/SampleCpuExtension).
...
> **NOTE**: Learn more about [OpenVINO extensibility](https://docs.openvino.ai/2022.3/openvino_docs_Extensibility_UG_Intro.html) 
