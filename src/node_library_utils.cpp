...
Status createTensorInfoMap(struct CustomNodeTensorInfo* info, int infoCount, std::map<std::string, std::shared_ptr<TensorInfo>>& out, release_ver2_fn nodeLibraryExecutor, void* customNodeLibraryInternalManager) {
    if (info == nullptr) {
