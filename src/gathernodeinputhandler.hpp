...
using shard_map_t = std::unordered_map<session_id_t, ov::runtime::Tensor>;
...
public:
    ...
    Status setInput(const std::string& inputName, ov::runtime::Tensor& tensor, session_id_t shardId) override;
