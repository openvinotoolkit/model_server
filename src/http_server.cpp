...
static const ovms::HTTPStatusCode http(const ovms::Status& status) {
    ...
    const std::map<const StatusCode, ovms::HTTPStatusCode> httpStatusMap = {
        ...
        {StatusCode::MEDIAPIPE_PUT_TO_SLEEP_STATE_NOT_AVAILABLE, ovms::HTTPStatusCode::PRECOND_FAILED},
        {StatusCode::MEDIAPIPE_PUT_TO_SLEEP_REQUESTS_IN_FLIGHT, ovms::HTTPStatusCode::PRECOND_FAILED},
        {StatusCode::MEDIAPIPE_PUT_TO_SLEEP_ACTIVE_INFERENCES, ovms::HTTPStatusCode::PRECOND_FAILED},
