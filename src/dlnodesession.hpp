...
public:
    DLNodeSession(const NodeSessionMetadata& metadata, const std::string& nodeName, uint32_t inputsCount, const ModelManager& manager, const std::string& modelName, model_version_t modelVersion);
    DLNodeSession(const NodeSessionMetadata&& metadata, const std::string& nodeName, uint32_t inputsCount, const ModelManager& manager, const std::string& modelName, model_version_t modelVersion);
