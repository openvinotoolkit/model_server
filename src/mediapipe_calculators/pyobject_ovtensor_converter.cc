...
public:
    static absl::Status GetContract(CalculatorContract* cc) {
        ...
        RET_CHECK(*(cc->Inputs().GetTags().begin()) == "OVTENSOR" || *(cc->Inputs().GetTags().begin()) == "OVMS_PY_TENSOR");
        RET_CHECK(*(cc->Outputs().GetTags().begin()) == "OVTENSOR" || *(cc->Outputs().GetTags().begin()) == "OVMS_PY_TENSOR");
        RET_CHECK(*(cc->Inputs().GetTags().begin()) != *(cc->Outputs().GetTags().begin()));
