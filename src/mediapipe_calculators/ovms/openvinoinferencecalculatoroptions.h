...
const std::vector<std::string> supportedTags = {SESSION_TAG, OVTENSOR_TAG, OVTENSORS_TAG, MPTENSOR_TAG, MPTENSORS_TAG};

const std::vector<std::string> supportedVectorTags = {OVTENSORS_TAG, MPTENSORS_TAG};
