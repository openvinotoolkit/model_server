...
// Normalize function_call_output.output to a string for downstream tool message
// handling in chat history.
//
// - If output is a string, preserve it as-is.
// - If output is an array of content items, flatten input_text/output_text items
//   into a newline-joined string; for mixed media payloads, preserve full content
//   by serializing the entire array to JSON.
