...
class LLMNodeResourcesInitializer {
    std::string basePath;
protected:
...
public:
    ...
    virtual Status initialize(std::shared_ptr<LLMNodeResources>& nodeResources, const mediapipe::LLMCalculatorOptions& nodeOptions, std::string graphPath) = 0;
};
