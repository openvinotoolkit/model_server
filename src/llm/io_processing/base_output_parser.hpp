...
public:
    ...
    // Get that tag that marks the beginning of the segment that should be processed by the parser.
    ...
    // Get that tag that marks the end of the segment that should be processed by the parser.
