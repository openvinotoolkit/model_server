...
Status createTensorInfoMap(struct CustomNodeTensorInfo* info, int infoCount, std::map<std::string, std::shared_ptr<TensorInfo>>& out, NodeLibraryExecutor& library, void* customNodeLibraryInternalManager);
