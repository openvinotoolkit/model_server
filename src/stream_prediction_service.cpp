...
//*****************************************************************************
#include "stream_prediction_service.hpp"
...
PredictionServiceStreamImpl::PredictionServiceStreamImpl(ovms::Server& ovmsServer) :
...
Status PredictionServiceStreamImpl::getModelInstance(const PredictRequest* request,
...
Status PredictionServiceStreamImpl::getPipeline(const PredictRequest* request,
...
grpc::Status ovms::PredictionServiceStreamImpl::Predict(
