...
#include "src/tfservingstream_api/stream_prediction_service.grpc.pb.h"
...
class PredictionServiceStreamImpl final : public tensorflow::serving::PredictionServiceStream::Service {
    ovms::Server& ovmsServer;
    ModelManager& modelManager;

public:
    PredictionServiceStreamImpl(ovms::Server& ovmsServer);
    grpc::Status Predict(
