...
protected:
    ...
    /**
         ...
         * @return status
         */
    virtual Status addVersion(const ModelConfig& config, ov::runtime::Core& ieCore);
    ...
    /**
         ...
         */
    virtual std::shared_ptr<ovms::ModelInstance> modelInstanceFactory(const std::string& modelName, const model_version_t modelVersion, ov::runtime::Core& ieCore);
...
public:
    ...
    /**
         ...
         * @return status
         */
    Status addVersions(std::shared_ptr<model_versions_t> versions, ovms::ModelConfig& config, std::shared_ptr<FileSystem>& fs, ov::runtime::Core& ieCore, std::shared_ptr<model_versions_t> versionsFailed);
    ...
    /**
         ...
         * @return status
         */
    Status reloadVersions(std::shared_ptr<model_versions_t> versions, ovms::ModelConfig& config, std::shared_ptr<FileSystem>& fs, ov::runtime::Core& ieCore, std::shared_ptr<model_versions_t> versionsFailed);
