...
std::string getAnonFilePath() { return std::string("azure://my-sample-share/my-sample-directory/my_test_file.txt"); }

std::string getAnonDirPath() { return std::string("azure://my-sample-share/my-sample-directory"); }

std::string getAnonBlobFilePath() { return std::string("azure_blob://my-sample-container/my-sample-directory/my_test_file.txt"); }

std::string getBlobDirPath() { return std::string("azure_blob://my-sample-container/my-sample-directory"); }

std::string getPrivateFilePath() { return std::string("azure://my-sample-share/my-sample-directory/my-sample-subdirectory/my_test_file2.txt"); }

std::string getPrivateDirPath() { return std::string("azure://my-sample-share/my-sample-directory/my-sample-subdirectory"); }

std::string getPrivateBlobFilePath() { return std::string("azure_blob://my-sample-container/my-sample-directory/my-sample-subdirectory/my_test_file2.txt"); }

std::string getPrivateBlobDirPath() { return std::string("azure_blob://my-sample-container/my-sample-directory/my-sample-subdirectory"); }
...
void check_dir_recursive_download(const std::string& path,
    ovms::FileSystem* fs) {
    SPDLOG_TRACE("Checking AS directory in a recursive way for {}", path);
    ovms::StatusCode status;
...
void check_dir_access(const std::string& path, ovms::FileSystem* fs) {
    SPDLOG_TRACE("Checking directory AS access for {}", path);
    ovms::StatusCode status;
    bool exists;
    status = fs->fileExists(path, &exists);
    EXPECT_EQ(status, ovms::StatusCode::OK);
