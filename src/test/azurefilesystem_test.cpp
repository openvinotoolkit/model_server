...
std::string getAnonTensorFilePath() { return std::string("az://my-sample-container/my-sample-directory/my_test_file.txt"); }

std::string getTensorDirPath() { return std::string("az://my-sample-container/my-sample-directory"); }
...
std::string getPrivateTensorFilePath() { return std::string("az://my-sample-container/my-sample-directory/my-sample-subdirectory/my_test_file2.txt"); }

std::string getPrivateTensorDirPath() { return std::string("az://my-sample-container/my-sample-directory/my-sample-subdirectory"); }
