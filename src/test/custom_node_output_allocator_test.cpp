...
public:
    CustomNodeOutputAllocatorCheckingFreeCalled(struct CustomNodeTensor tensor, NodeLibrary nodeLibrary, std::shared_ptr<void*>& customNodeLibraryInternalManager) :
