...
public:
    static void SetUpTestSuite() {
        ...
        char* argv[] = {
            ...
            (char*)"dummy",
            (char*)"--model_path",
            (char*)getWindowsFullPathForSrcTest("/ovms/src/test/dummy"),
            (char*)"--log_level",
            (char*)"DEBUG",
            (char*)"--batch_size",
            (char*)"auto",
...
public:
    static void SetUpTestSuite() {
        ...
        char* argv[] = {
            ...
            (char*)"scalar",
            (char*)"--model_path",
            (char*)getWindowsFullPathForSrcTest("/ovms/src/test/scalar"),
            (char*)"--log_level",
            (char*)"DEBUG",
            (char*)"--port",
            (char*)port.c_str(),
...
public:
    static void SetUpTestSuite() {
        ...
        char* argv[] = {
            ...
            (char*)"string",
            (char*)"--model_path",
            (char*)getWindowsFullPathForSrcTest("/ovms/src/test/passthrough_string"),
            (char*)"--log_level",
            (char*)"DEBUG",
            (char*)"--port",
            (char*)port.c_str(),
...
protected:
    ...
    void SetUp() {
        SetUpServer(getWindowsFullPathForSrcTest("/ovms/src/test/mediapipe/config_python_summator.json"));
    }
...
protected:
    void SetUp() {
        SetUpServer(getWindowsFullPathForSrcTest("/ovms/src/test/mediapipe/config_mp_pytensor_passthrough.json"));
    }
};
