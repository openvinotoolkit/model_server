...
TEST_F(MistralOutputParserTest, HolisticStreaming) {
...
TEST_F(MistralOutputParserTest, StreamingToolWithComplexArguments) {
...
TEST_F(MistralOutputParserTest, ToolCallsWithoutToolsInTheRequestStreaming) {
