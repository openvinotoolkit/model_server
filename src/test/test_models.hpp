...
const std::string dummy_fp64_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/dummy_fp64", false);
const std::string sum_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/add_two_inputs_model", false);
const std::string increment_1x3x4x5_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/increment_1x3x4x5", false);
const std::string passthrough_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/passthrough", false);
const std::string passthrough_string_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/passthrough_string", false);
const std::string dummy_saved_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/dummy_saved_model", false);
const std::string dummy_tflite_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/dummy_tflite", false);
const std::string scalar_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/scalar", false);
const std::string no_name_output_model_location = getGenericFullPathForSrcTest(std::filesystem::path(std::filesystem::current_path()) / "src/test/no_name_output", false);
