...
TEST(SequenceManager, CreateSequenceOK) {
    MockedSequenceManager sequenceManager(120, 24, "dummy");
...
TEST(SequenceManager, AutoRemoveOneTimedOutSequence) {
    ...
    MockedSequenceManager sequenceManager(5, 24, "dummy");
...
TEST(SequenceManager, AutoRemoveAllTimedOutSequences) {
    MockedSequenceManager sequenceManager(2, 24, "dummy");
    sequenceManager.mockCreateSequence(42);
    sequenceManager.mockCreateSequence(314);
