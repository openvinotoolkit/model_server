...
void checkDummyResponse(const std::string outputName,
    ...
    tensorflow::serving::PredictRequest& request, tensorflow::serving::PredictResponse& response, int seriesLength, int batchSize = 1, std::string servableName = "");

void checkDummyResponse(const std::string outputName,
    const std::vector<float>& requestData,
    ::KFSRequest& request, ::KFSResponse& response, int seriesLength, int batchSize = 1, std::string servableName = "");
