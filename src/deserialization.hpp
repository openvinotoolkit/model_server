...
InferenceEngine::Blob::Ptr makeBlob(const tensorflow::TensorProto& requestInput,
    ...
    return InferenceEngine::make_shared_blob<T>(
        getFinalShapedTensorDesc(*tensorInfo, requestInput, isPipeline),
...
public:
    static InferenceEngine::Blob::Ptr deserializeTensorProto(
        ...
        case InferenceEngine::Precision::FP16: {
            auto blob = InferenceEngine::make_shared_blob<uint16_t>(getFinalShapedTensorDesc(*tensorInfo, requestInput, isPipeline));
            blob->allocate();
