...
void addEntryAndReturnIfContainsModel(const std::filesystem::__cxx11::path& directoryPath, std::unordered_map<std::string, ovms::ServableType_t>& servablesList, std::string& dirName, bool& retFlag);
void NewFunction(const std::filesystem::__cxx11::directory_entry& entry, std::unordered_map<std::string, ovms::ServableType_t>& servablesList, std::string& dirName, bool& retFlag);
} // namespace ovms
