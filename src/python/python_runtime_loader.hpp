...
// Load Python runtime library (libovmspython.so/dll) and resolve entry point symbols.
// Returns a pointer to the created Python interpreter module instance, or nullptr on failure.
