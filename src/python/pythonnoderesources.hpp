...
public:
    ...
    ~PythonNodeResources();
    static Status createPythonNodeResources(std::shared_ptr<PythonNodeResources>& nodeResources, const ::mediapipe::CalculatorGraphConfig::Node& graphNode, PythonBackend* pythonBackend, std::string basePath);
    void finalize();
