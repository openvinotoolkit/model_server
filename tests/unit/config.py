...
INPUT_FORMAT_CHECK_TEST_CASES = [
    ...
    ({"inputs": [1,2,3], "instances": ["a","b","c"]}, INVALID_FORMAT, NO_EVALUATION),

    ({"inputs": []}, INVALID_FORMAT, INPUTS_EVALUATION),
    ({"inputs": {}}, INVALID_FORMAT, INPUTS_EVALUATION),
    ({"instances": []}, INVALID_FORMAT, INSTANCES_EVALUATION),
    ({"instances": {}}, INVALID_FORMAT, INSTANCES_EVALUATION),
    ({"instances": {"input": [1,2,3]}}, INVALID_FORMAT, INSTANCES_EVALUATION),
    ...
    ({"instances": [{"wrong_key": [1,2,3]}]}, INVALID_FORMAT, INSTANCES_EVALUATION),
    ...
    ({"inputs": {"input_key": [1,2,3], "xxx": 1}}, COLUMN_FORMAT, INPUTS_EVALUATION),
