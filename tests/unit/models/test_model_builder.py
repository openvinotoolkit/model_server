...
def test_build_local_model(mocker):
    ...
    ModelBuilder.build('model_name', 'opt/bucket/model', None, None, None)
...
def test_build_gs_model(mocker):
    ...
    ModelBuilder.build('model_name', 'gs://bucket/model', None, None, None)
...
def test_build_s3_model(mocker):
    ...
    ModelBuilder.build('model_name', 's3://bucket/model', None, None, None)
