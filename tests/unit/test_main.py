...
@pytest.mark.parametrize("should_fail, model_version_policy, exceptions", [
    (False, '{"specific": { "versions":[1,2] }}', None),
    (True, '{"specific": { "test": }}', (SystemExit, Exception)),
    (True, '{"specific": { "ver":[1,2] }}', (SystemExit, main.ValidationError))
])
