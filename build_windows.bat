...
set buildCommand=bazel build --config=windows --jobs=%NUMBER_OF_PROCESSORS% --verbose_failures --define CLOUD_DISABLE=1 --define MEDIAPIPE_DISABLE=1 --define PYTHON_DISABLE=1 //src:ovms ^> compilation.log 2^>^&1
