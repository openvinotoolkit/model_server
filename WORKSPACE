...
git_repository(
    ...
    commit = "9ce4014907b7e5bb70147c6864282b8503418619", # Support getting output metadata in model api adapter
)
...
load("@mediapipe//third_party/model_api:model_api.bzl", "model_api_repository", "workspace_model_api")
#workspace_model_api()
