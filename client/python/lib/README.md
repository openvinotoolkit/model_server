...
See [API documentation](https://github.com/openvinotoolkit/model_server/blob/v2021.4.2/client/python/lib/docs/README.md) for details on what the library provides.
...
For more details on `ovmsclient` see [API reference](https://github.com/openvinotoolkit/model_server/blob/v2021.4.2/client/python/lib/docs/README.md)