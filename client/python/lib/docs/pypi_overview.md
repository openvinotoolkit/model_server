...
See [API reference](https://github.com/openvinotoolkit/model_server/blob/v2021.4.2/client/python/lib/docs/README.md) for usage details.
...
Learn more on `ovmsclient` [documentation site](https://github.com/openvinotoolkit/model_server/tree/v2021.4.2/client/python/lib).