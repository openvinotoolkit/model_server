...
See [API reference](https://github.com/openvinotoolkit/model_server/blob/releases/2024/5/client/python/ovmsclient/lib/docs/README.md) for usage details.
...
Learn more on `ovmsclient` [documentation site](https://github.com/openvinotoolkit/model_server/tree/releases/2024/5/client/python/ovmsclient/lib).