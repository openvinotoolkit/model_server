...
from utils.utils import get_single_metadata, read_imgs_as_ndarray
...
parser.add_argument('--images_dir', required=False, default='./utils/resnet_images.txt',
                    help='Path to images')
...
input_name, output_name = get_single_metadata(client, model_name, model_version)

# preparing images
imgs = read_imgs_as_ndarray(images_dir, 224, 224)
...
for i in range(imgs.shape[0]):
    ...
    print(f"Image {i} has been classified as {label} with {confidence_score}% confidence")
