...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Sends request via KServe HTTP API to check if model is ready.')
    ...
    print(f"Model Ready: {client.is_model_ready(args['model_name'],args['model_version'])}")
