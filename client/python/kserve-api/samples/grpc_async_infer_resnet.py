...
if __name__ == '__main__':
    ...
    parser.add_argument('--timeout', required=False, help='Request timeout', default=10)
            ...
            for i in range(nu.shape[0]):
                ...
                if args.get('labels_numpy_path') is not None:
                    ...
                    if ma == lb[data[x][1]]:
                        ...
                        mark_message = "; Incorrect match. Should be {} {}".format(lb[data[x][1]], classes.imagenet_classes[lb[data[x][1]]] )
