...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Sends request via KServe HTTP API to check if server is alive.')
    ...
    print("Server Live: {}".format(client.is_server_live()))
