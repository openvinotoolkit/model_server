...
if __name__ == '__main__':
    ...
    parser.add_argument('--http_address', required=False, default='localhost',
    ...
    parser.add_argument('--binary_data', default=False, action='store_true',
                        help='Send input data in binary format', dest='binary_data')
                ...
                if args.get('labels_numpy_path') is not None:
                    ...
                    if ma == lb[x]:
                        ...
                        mark_message = "; Incorrect match. Should be {} {}".format(
                            lb[x], classes.imagenet_classes[lb[x]])
