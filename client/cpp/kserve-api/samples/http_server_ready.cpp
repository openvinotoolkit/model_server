...
int main(int argc, char** argv) {
    ...
    ("http_address", "Specify url to http service. ", cxxopts::value<std::string>()->default_value("localhost"))
    ("http_port", "Specify port to http service. ", cxxopts::value<std::string>()->default_value("8000"))
