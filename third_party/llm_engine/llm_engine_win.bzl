...
def _impl(repository_ctx):
    http_proxy = repository_ctx.os.environ.get("HTTP_PROXY", "http://proxy-igk.intel.com:911")
    https_proxy = repository_ctx.os.environ.get("HTTPS_PROXY", "http://proxy-igk.intel.com:912")
...
cmake(
    ...
    lib_source = ":all_srcs",
    out_dll_dir = "runtime/bin/Release",
