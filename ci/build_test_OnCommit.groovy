          ...
          parallel {
            stage("Build linux") {
              ...
              steps {
                      ...
                      sh "make ovms_builder_image RUN_TESTS=0 OPTIMIZE_BUILDING_TESTS=1 OV_USE_BINARY=1 BASE_OS=ubuntu22 OVMS_CPP_IMAGE_TAG=${shortCommit} BUILD_IMAGE=openvino/model_server-build:${shortCommit}"
                    }
            }
            stage('Build windows') {
              agent {
