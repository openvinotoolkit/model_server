          ...
          parallel {
            stage("Build linux") {
              ...
              steps {
                      ...
                      sh "make ovms_builder_image RUN_TESTS=0 OPTIMIZE_BUILDING_TESTS=1 NO_DOCKER_CACHE=true OV_USE_BINARY=0 BASE_OS=redhat OVMS_CPP_IMAGE_TAG=${shortCommit} BUILD_IMAGE=openvino/model_server-build:${shortCommit}"
                    }
            }
            stage('Build windows') {
              agent {
        ...
        stage("Release image and tests in parallel") {
          ...
          parallel {
            ...
            stage("Internal tests") {
              ...
              steps {
                sh "make release_image RUN_TESTS=0 OV_USE_BINARY=0 NO_DOCKER_CACHE=true BASE_OS=redhat OVMS_CPP_IMAGE_TAG=${shortCommit} BUILD_IMAGE=openvino/model_server-build:${shortCommit}"
