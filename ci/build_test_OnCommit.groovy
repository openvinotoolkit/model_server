          ...
          parallel {
            stage("Build linux") {
              ...
              steps {
                      ...
                      sh "make ovms_builder_image RUN_TESTS=0 NO_DOCKER_CACHE=true OV_USE_BINARY=0 BASE_OS=redhat OVMS_CPP_IMAGE_TAG=${shortCommit} BUILD_IMAGE=openvino/model_server-build:${shortCommit}"
                    }
            }
            stage('Build windows') {
              agent {
