...
pipeline {
    ...
    stages {
        stage("Build windows") {
          steps {
                bat "${vsDevPath} && ${setPath} && ${logPath} $$ ${buildCommand}"
              }
        }
    }
}
