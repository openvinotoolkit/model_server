...
if "%GENAI_PACKAGE_URL%"=="" (
    set "GENAI_PACKAGE_URL=https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2025.3.0.0.dev20250728/openvino_genai_windows_2025.3.0.0.dev20250728_x86_64.zip"
)
