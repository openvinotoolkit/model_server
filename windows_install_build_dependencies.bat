...
if "%GENAI_PACKAGE_URL%"=="" (
    set "GENAI_PACKAGE_URL=https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20251209/openvino_genai_windows_2026.0.0.0.dev20251209_x86_64.zip"
)
...
if "%OV_SOURCE_BRANCH%"=="" (
    set "OV_SOURCE_BRANCH=9f43e0c9a5dab9b014a01259558aa8ddaa23d46c"
)
if "%OV_SOURCE_ORG%"=="" (
...
if "%GENAI_SOURCE_BRANCH%"=="" (
    set "GENAI_SOURCE_BRANCH=b1d835c85c68ad2e3b57ea91423bf64b74581f82"
)
