...
if "%GENAI_PACKAGE_URL%"=="" (
    set "GENAI_PACKAGE_URL=https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2026.0.0.0.dev20260123/openvino_genai_windows_2026.0.0.0.dev20260123_x86_64.zip"
)
...
if "%OV_SOURCE_BRANCH%"=="" (
    set "OV_SOURCE_BRANCH=8029cea3ed525a2995be108db9b9cab8a15db272"
)
if "%OV_SOURCE_ORG%"=="" (
...
if "%GENAI_SOURCE_BRANCH%"=="" (
    set "GENAI_SOURCE_BRANCH=cd9505689ce868c4750c89caf8ae993fa702ec6e"
)
