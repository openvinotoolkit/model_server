...
set "genai_dir=openvino_genai_windows_2025.1.0.0rc3_x86_64"
set "genai_ver=openvino_genai_windows_2025.1.0.0rc3_x86_64.zip"
set "genai_http=https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/pre-release/2025.1.0.0rc3/"
