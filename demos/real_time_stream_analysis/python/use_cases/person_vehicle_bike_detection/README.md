...
Model used in this example is [person-vehicle-bike-detection-2002](https://docs.openvino.ai/2023.1/omz_models_model_person_vehicle_bike_detection_2002.html).
...
Modify streaming app main script - [`real_time_stream_analysis.py`](https://github.com/openvinotoolkit/model_server/blob/releases/2023/1/demos/real_time_stream_analysis/python/real_time_stream_analysis.py) to contain the following:
...
<img src="https://github.com/openvinotoolkit/model_server/blob/releases/2023/1/demos/real_time_stream_analysis/python/assets/visualizer_example_browser.gif">