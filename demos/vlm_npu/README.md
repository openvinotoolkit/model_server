...
curl https://raw.githubusercontent.com/openvinotoolkit/model_server/refs/heads/main/demos/vlm_npu/generation_config.json -o models/microsoft/Phi-3.5-vision-instruct/generation_config.json
```
