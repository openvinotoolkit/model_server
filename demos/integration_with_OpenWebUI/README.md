...
![get started with Open WebUI](./get started with Open WebUI.png)
...
![connection setting](./connection setting.png)
...
![embedding and retrieval setting](./embedding and retrieval setting.png)
...
![create a knowledge base](./create a knowledge base.png)
...
![chat with RAG demo](./chat with RAG demo.png)
...
![create and configure the RAG-enabled model](./create and configure the RAG-enabled model.png)

3. Click **Save & Create**
4. Click the created model and start chatting

![RAG-enabled model demo](./RAG-enabled model demo.png)
...
![image generation setting](./image generation setting.png)
...
![image generation method 1 demo](./image generation method 1 demo.png)
...
![image generation method 2 demo](./image generation method 2 demo.png)
...
![chat with VLM demo](./chat with VLM demo.png)
...
![tools setting](./tools setting.png)
...
![chat with AI Agent demo](./chat with AI Agent demo.png)
