...
docker run -it -w /home/user/workdir  --rm  -v `pwd`/ovms/pose_detection/1:/home/user/workdir ghcr.io/pinto0309/tflite2tensorflow:latest tflite2tensorflow --model_path pose_detection.tflite --flatc_path ../flatc --schema_path ../schema.fbs --output_pb
docker run -it  --rm -w /home/user/workdir -v `pwd`/ovms/pose_detection/1:/home/user/workdir ghcr.io/pinto0309/tflite2tensorflow:latest tflite2tensorflow --model_path pose_detection.tflite --flatc_path ../flatc --schema_path ../schema.fbs --output_no_quant_float32_tflite
...
docker run -it  --rm -w /home/user/workdir -v `pwd`/ovms/pose_detection/1:/home/user/workdir ghcr.io/pinto0309/tflite2tensorflow:latest rm -Rf saved_model pose_detection.json
chmod -R 755 ovms/ 
