...
Prepare virtualenv according to [kserve samples readme](https://github.com/openvinotoolkit/model_server/blob/releases/2026/0/client/python/kserve-api/samples/README.md)
```bash
