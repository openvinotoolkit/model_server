...
Prepare virtualenv according to [kserve samples readme](https://github.com/openvinotoolkit/model_server/tree/releases/2026/3/client/python/kserve-api/samples/README.md)
```bash
