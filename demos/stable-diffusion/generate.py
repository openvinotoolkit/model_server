...
if args["adapter"] == "openvino":
    ...
    unet_model = OVMSAdapter("localhost:15000/models/unet")
    vae_decoder_model = OVMSAdapter("localhost:15000/models/vae_decoder")
    vae_encoder_model = OVMSAdapter("localhost:15000/models/vae_encoder")
    text_encoder_model = OVMSAdapter("localhost:15000/models/text_encoder")
