...
```console
curl -O https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/4/demos/image_generation/cat.png
curl -O https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/4/demos/image_generation/cat_mask.png
```
...
Download sample images:
```console
curl -O https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/4/demos/image_generation/outpaint_input.png
curl -O https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/4/demos/image_generation/outpaint_mask.png
```
