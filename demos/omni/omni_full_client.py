...
Usage:
    python3 omni_full_client.py --audio recording.wav --image photo.jpg
    python3 omni_full_client.py --audio recording.wav --prompt "Transcribe this"
    python3 omni_full_client.py --image photo.jpg --prompt "Describe this image"
    python3 omni_full_client.py --audio recording.wav --image photo.jpg --voice m02
