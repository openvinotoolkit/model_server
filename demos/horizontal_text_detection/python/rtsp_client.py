...
client.start(ovms_address=args.grpc_address, input_name=args.input_name, model_name=args.model_name, stream_timeout = args.stream_timeout, limit_frames = args.limit_frames)
