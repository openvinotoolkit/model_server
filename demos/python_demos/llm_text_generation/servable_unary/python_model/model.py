...
MODEL_PATH = "../../model"  # relative to python module
...
class OvmsPythonModel:
    def initialize(self, kwargs: dict):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(kwargs['base_path'] + MODEL_PATH, trust_remote_code=True)
        ...
        self.ov_model = OVModelForCausalLM.from_pretrained(
            kwargs['base_path'] + MODEL_PATH,
            device="AUTO",
            ov_config=OV_CONFIG,
            config=AutoConfig.from_pretrained(kwargs['base_path'] + MODEL_PATH, trust_remote_code=True))
