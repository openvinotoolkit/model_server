...
**This demo is deprecated and will be removed in 2024.0. Check out new [python demos](https://github.com/openvinotoolkit/model_server/tree/main/demos/python_demos) for latest examples with language models.**
