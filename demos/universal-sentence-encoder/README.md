...
Alternatively see (instructions)[https://github.com/openvinotoolkit/model_server/blob/releases/2026/3/docs/deploying_server_baremetal.md] for deployment on bare metal.
