...
docker run --user $(id -u):$(id -g) --rm -v $(pwd)/models:/models:rw openvino/model_server:latest --add_to_config /models --model_name Qwen3-Coder-30B-A3B-Instruct  --model_path Qwen3-Coder-30B-A3B-Instruct
