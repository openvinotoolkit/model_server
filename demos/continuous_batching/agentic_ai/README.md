...
```console
curl https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/3/demos/continuous_batching/agentic_ai/openai_agent.py -O -L
...
Running `docker run` command, use the image with GPU support. Export the models with precision matching the [NPU capacity](https://docs.openvino.ai/releases/2026/3/openvino-workflow-generative/inference-with-genai/inference-with-genai-on-npu.html) and adjust pipeline configuration.
It can be applied using the commands below:
...
curl https://raw.githubusercontent.com/openvinotoolkit/model_server/releases/2026/3/demos/continuous_batching/agentic_ai/llama_index_agent.py -o llama_index_agent.py
...
```
For more details, see [OpenVINO GenAI on NPU](https://docs.openvino.ai/releases/2026/3/openvino-workflow-generative/inference-with-genai/inference-with-genai-on-npu.html).