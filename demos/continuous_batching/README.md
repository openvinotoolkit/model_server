...
docker run -d ${GPU_ARGS} -p 8000:8000 --rm --user $(id -u):$(id -g) -v ${HOME}/models:/models/:rw openvino/model_server:2026.4.0-gpu --model_repository_path /models --source_model OpenVINO/Qwen3-30B-A3B-Instruct-2507-int4-ov --rest_port 8000 --model_name Qwen3-30B-A3B-Instruct-2507-int4-ov
```
...
Check the example in the [RAG notebook](https://github.com/openvinotoolkit/model_server/blob/releases/2026/4/demos/continuous_batching/rag/rag_demo.ipynb)

## Scaling the Model Server

Check this simple [text generation scaling demo](https://github.com/openvinotoolkit/model_server/blob/releases/2026/4/demos/continuous_batching/scaling/README.md).
