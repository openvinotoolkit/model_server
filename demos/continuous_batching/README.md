...
Check the example in the [RAG notebook](https://github.com/openvinotoolkit/model_server/blob/releases/2026/3/demos/continuous_batching/rag/rag_demo.ipynb)

## Scaling the Model Server

Check this simple [text generation scaling demo](https://github.com/openvinotoolkit/model_server/blob/releases/2026/3/demos/continuous_batching/scaling/README.md).
