...
```bash
curl https://raw.githubusercontent.com/openvinotoolkit/model_server/refs/heads/releases/2026/2/demos/continuous_batching/long_context/custom_dataset.py -o custom_dataset.py
