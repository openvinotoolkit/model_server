...
parser.add_argument('--task_parameters', type=json.loads, default='{}', help='json format of parameters and values list', dest='task_parameters')
...
node: {
  ...
  node_options: {
      [type.googleapis.com / mediapipe.LLMCalculatorOptions]: {
          ...
          max_num_batched_tokens: {{max_num_batched_tokens|default("8192", false)}},
