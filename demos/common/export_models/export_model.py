...
parser_text.add_argument('--enable_prefix_caching', type=bool, default=True, help='This algorithm is used to cache the prompt tokens.', dest='enable_prefix_caching')
