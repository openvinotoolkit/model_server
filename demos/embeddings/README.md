...
```console
python export_model.py embeddings_ov --source_model BAAI/bge-large-en-v1.5 --model_name bge-large-en-v1.5 --pooling CLS --weight-format fp16 --target_device NPU --config_file_path models/config.json --model_repository_path models --max_length 400
```
:::
::::
...
Check this demo to see the langchain code example which is using OpenVINO Model Server both for text generation and embedding endpoint in [RAG application demo](https://github.com/openvinotoolkit/model_server/tree/releases/2026/4/demos/continuous_batching/rag)
...
The script [compare_results.py](https://raw.githubusercontent.com/openvinotoolkit/model_server/refs/heads/releases/2026/4/demos/embeddings/compare_results.py) can assist with such experiment.
```bash
popd
...
curl https://raw.githubusercontent.com/openvinotoolkit/model_server/refs/heads/releases/2026/4/demos/embeddings/ovms_mteb.py -o ovms_mteb.py
