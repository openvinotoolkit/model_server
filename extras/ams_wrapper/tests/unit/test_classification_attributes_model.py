...
@pytest.mark.parametrize("inference_output,expected_response", [
                        ...
                        {"type": "classification", "subtype": None,
                         "classifications": [{"attributes": [
                          ...
                          {"name": "color", "value": "white", "confidence": 0.05},
                          {"name": "color", "value": "black", "confidence": 0.05}]},
                         {"attributes": [
                          {"name": "type", "value": "van", "confidence": 0.5},
                          {"name": "type", "value": "car", "confidence": 0.2},
                          {"name": "type", "value": "bus", "confidence": 0.2},
                          {"name": "type", "value": "truck", "confidence": 0.1},
                          ]}]}
                          )])
