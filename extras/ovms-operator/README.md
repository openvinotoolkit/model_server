...
OVMS operator on OpenShift infrastructure is now replaced with the [OpenVINO Operator](https://github.com/openvinotoolkit/model_server/blob/releases/2023/0/extras/openvino-operator-openshift).
...
It can be done by editing the [sample resource](https://github.com/openvinotoolkit/model_server/blob/releases/2023/0/extras/ovms-operator/config/samples/intel_v1alpha1_ovms.yaml) and running a command:
