...
// DecodeResnetLabel takes an index and returns the label as a string
func DecodeResnetLabel(index int) (label string, err error) {
	if index > len(labels) || index < 0 {
...
// Labels is an array of RESNET labels
var labels = [...]string{
	"tench, Tinca tinca",
